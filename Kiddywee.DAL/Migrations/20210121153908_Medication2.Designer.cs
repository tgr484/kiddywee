...
namespace Kiddywee.DAL.Migrations
{
    ...
    [Migration("20210121153908_Medication2")]
    partial class Medication2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kiddywee.DAL.Models.DailyReportBathroom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DailyReportBathrooms");
                });

            modelBuilder.Entity("Kiddywee.DAL.Models.DailyReportFood", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("DailyReportMealId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DailyReportMealId");

                    b.ToTable("DailyReportFoods");
                });

            modelBuilder.Entity("Kiddywee.DAL.Models.DailyReportMeal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DailyReportMeals");
                });

            modelBuilder.Entity("Kiddywee.DAL.Models.DailyReportMedication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DailyReportMedications");
                });

            modelBuilder.Entity("Kiddywee.DAL.Models.DailyReportNap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DailyReportNaps");
                });

            modelBuilder.Entity("Kiddywee.DAL.Models.DailyReportNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kiddywee.DAL.Models.DailyReportFood", b =>
                {
                    ...
                    b.HasOne("Kiddywee.DAL.Models.DailyReportMeal", "DailyReportMeal")
                        .WithMany("DailyReportFoods")
                        .HasForeignKey("DailyReportMealId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
