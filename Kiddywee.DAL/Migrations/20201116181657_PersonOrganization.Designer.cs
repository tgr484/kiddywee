...
namespace Kiddywee.DAL.Migrations
{
    ...
    [Migration("20201116181657_PersonOrganization")]
    partial class PersonOrganization
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kiddywee.DAL.Models.ChildInfo", b =>
                {
                    ...
                    b.Property<Guid?>("ImmunisationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kiddywee.DAL.Models.MedicalInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kiddywee.DAL.Models.ChildInfo", b =>
                {
                    ...
                    b.HasOne("Kiddywee.DAL.Models.MedicalInfo", "Immunisation")
                        .WithMany()
                        .HasForeignKey("ImmunisationId");
